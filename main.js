...
this.wordle = this.wordle || {}, this.wordle.bundle = function(exports) {
  ...
  function isDate(a) {
    var i;
    var j = getTime(a);
    return i = j * 22543 % updatedSet.length, updatedSet[i];
  }
  /**
   * @param {!Date} token
   * @return {?}
  ...
  /** @type {string} */
  nodes.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    left: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n    display: flex;\n    justify-content: space-between;\n    align-items: flex-end;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Сложный вариант</div>\n          <div class="description">Каждая подсказка должна использоваться в последующих попытках.</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Тёмная тема</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Контрастные цвета</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n      </div>\n    </section>\n\n     <section>\n      <div class="setting">\n        <div class="text">\n          <p>Автор оригинальной игры: Джош Уордл. Вы можете играть на английском <a href = "https://www.powerlanguage.co.uk/wordle/">по ссылке</a>. <p>Автор белорусской игры: OloloPhilolo. Вы можете играть на белорусском <a href = "https://ololophilolo.github.io/wordle-by/">по ссылке</a><br> \n    </section>\n  </div>\n  <div id="footnote">\n    <div>\n      <div id="puzzle-number"></div>\n </div>\n  </div>\n';
  ...
  /** @type {string} */
  var choices = "абвгдеёжзийклмнопрстущфхцчш’ыьэюя";
  /** @type {!Array<?>} */
  ...
  var obj = "FAIL";
  /** @type {!Array} */
  var pedalboards = ["Невероятно!", "Отлично!", "Достойно!", "Здорово!", "Хорошо!", "Ух!"];
    ...
    return trigger(init, [{
      ...
      value : function() {
        if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
          ...
          if (!(integer == this.solution) && (value = integer, updatedSet.includes(value))) {
            return brickInput.setAttribute("invalid", ""), void this.addToast("Ругательства запрещены (ну, почти)!");
          }
          if (value = integer, !(integer == this.solution) && !options.includes(value)) {
            return brickInput.setAttribute("invalid", ""), void this.addToast("Нет такого слова в словаре!");
          }
          if (this.hardMode) {
      ...
      value : function() {
        if (this.gameStatus === exitCode && this.canInput) {
          if (5 !== this.tileIndex) {
            return this.$board.querySelectorAll("game-row")[this.rowIndex].setAttribute("invalid", ""), void this.addToast("Не хватает букв!");
          }
          this.evaluateRow();
        }
      }
      ...
      value : function() {
        ...
        this.shadowRoot.getElementById("settings-button").addEventListener("click", function(a) {
          ...
          /** @type {!Text} */
          var debug = document.createTextNode("Настройки");
        ...
        this.shadowRoot.getElementById("help-button").addEventListener("click", function(a) {
          ...
          /** @type {!Text} */
          var t = document.createTextNode("Как играть");
          s.appendChild(t);
          /** @type {!Element} */
  ...
  var pipelets = [["ё", "й", "ц", "у", "к", "е", "н", "г", "ш", "щ", "з", "х", "ъ"], ["ф", "ы", "в", "а", "п", "р", "о", "л", "д", "ж", "э"], ["↵", "я", "ч", "с", "м", "и", "т", "ь", "б", "ю", "←"]];
      ...
      value : function() {
        ...
        pipelets.forEach(function(wrappersTemplates) {
          ...
          wrappersTemplates.forEach(function(char) {
            var span;
            if ((char >= "а" && char <= "я") || "’" === char || "ё" === char || "і" === char || "ў" === char || "←" === char || "↵" === char) {
  ...
  /** @type {string} */
  cached.innerHTML = '\n  <div class="countdown">\n    <h1>Следующий Bawdrle</h1>\n    <div id="timer">\n      <div class="statistic-container">\n        <div class="statistic timer">\n          <countdown-timer></countdown-timer>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class="share">\n    <button id="share-button">\n      Поделиться <game-icon icon="share"></game-icon>\n    </button>\n  </div>\n';
  var dragitemhomes = {
currentStreak : "Текущая серия",
     maxStreak : "Лучшая партия",
     winPercentage : "% побед",
     gamesPlayed : "Всего игр",
     gamesWon : "Выиграл",
     mediumGuesses : "Среднее количество попыток"
  };
          ...
          this.shadowRoot.querySelector("button#share-button").addEventListener("click", function(event) {
            ...
            render(function(data) {
              ...
              return a.forEach(function(wrappersTemplates) {
                ...
                text : "".concat(level, "\n\n").concat(url.trimEnd()).concat("\n").concat("https://lkurakht.github.io/bawdrle/")
              };
            }({
              ...
              self.gameApp.addToast("Результат копируется!", 2E3, true);
            }, function() {
              self.gameApp.addToast("Не удалось поделиться результатами", 2E3, true);
            });
          });
        }
      }
  ...
  /** @type {string} */
  element.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Отгадайте <strong>Bawdrle</strong> за 6 попыток.</p>\n      <p>Каждая попытка должна содержать существующее слово из пяти букв. Ругательства допустимы только в качестве ответа и при подборе отклоняются. Нажмите Enter, чтобы подтвердить попытку.</p>\n <p>После каждой попытки цвет клетки будет меняться, чтобы показать, насколько близко ваше предположение было к слову.</p>\n      <div class="examples">\n        <p><strong>Примеры</strong></p>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="З" evaluation="correct" reveal></game-tile>\n            <game-tile letter="а"></game-tile>\n            <game-tile letter="б"></game-tile>\n            <game-tile letter="о"></game-tile>\n            <game-tile letter="р"></game-tile>\n          </div>\n          <p>Буква <strong>З</strong> есть в слове на правильном месте.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="п"></game-tile>\n            <game-tile letter="л" evaluation="present" reveal></game-tile>\n            <game-tile letter="е"></game-tile>\n            <game-tile letter="с"></game-tile>\n            <game-tile letter="к"></game-tile>\n          </div>\n          <p>Буква <strong>Л</strong> есть в слове, но находится на другом месте.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="а"></game-tile>\n            <game-tile letter="н"></game-tile>\n            <game-tile letter="г"></game-tile>\n            <game-tile letter="а"></game-tile>\n            <game-tile letter="р" ></game-tile>\n          </div>\n          <p>Букв в слове нет.</p>\n        </div>\n      </div>\n      <p><strong>Новые Bawdrle появляются каждый день!</strong></p>\n    </div>\n  </section>\n';
